...
public class DMZTrBioAndroidConfig {
    ...
    static {
        ...
        MULTIPLIER_BASE = BUILDER.comment("Multiplier for Imperfect Form! (Min: 1.0 / Max: 200.0)")
                .defineInRange("Multiplier: ", 1.0, 1.0, 200.0);


        BASE_FORM_KI_COST = BUILDER.comment("Ki Cost for Imperfect Form! (Min: 0 / Max: 20000)")
