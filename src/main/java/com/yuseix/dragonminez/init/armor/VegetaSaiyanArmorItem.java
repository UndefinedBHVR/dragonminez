...
public class VegetaSaiyanArmorItem extends ArmorItem{

    private static final String LAYER1 = new ResourceLocation(DragonMineZ.MOD_ID, "textures/armor/saiyans/vegeta_saiyan_armor_layer1.png").toString();
    private static final String LAYER2 = new ResourceLocation(DragonMineZ.MOD_ID, "textures/armor/saiyans/vegeta_saiyan_armor_layer2.png").toString();
