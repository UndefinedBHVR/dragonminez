...
import com.yuseix.dragonminez.init.armor.client.model.GokuArmorModel;
...
public class GokuArmorRenderer extends GeoArmorRenderer<GokuArmorItem> {
    ...
    @Override
    public void preRender(PoseStack poseStack, GokuArmorItem animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        resetBones();
