...
public class ArmorSaiyanModel extends HumanoidModel<LivingEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DragonMineZ.MOD_ID, "armors"), "saiyan");
	...
	public ArmorSaiyanModel(ModelPart root) {
        super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(14, 32).addBox(0.0F, -2.0F, -2.0F, 0.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.3F, 10.25F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(1, 32).addBox(-1.0F, -2.0F, -2.0F, 0.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.35F, 10.65F, 0.0F, 0.0F, 0.0F, 0.1309F));
		...
		PartDefinition cube_r3 = right_arm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(42, 37).addBox(-2.0F, -2.0F, -2.0F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-2.7F, -0.75F, -0.5F, 0.0F, 0.0F, 0.1309F));
		...
		PartDefinition cube_r4 = left_arm.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(25, 33).addBox(-1.0F, -2.0F, -2.5F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.25F, -0.35F, 0.0F, 0.0F, 0.0F, -0.1309F));
