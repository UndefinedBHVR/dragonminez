...
public class Dball1NamekBlockEntity extends BlockEntity implements GeoBlockEntity {

	private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public Dball1NamekBlockEntity(BlockPos pPos, BlockState pBlockState) {
		super(MainBlockEntities.DBALL1_NAMEK_BLOCK_ENTITY.get(), pPos, pBlockState);
	}
