...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(MainBiomes.NAMEK_BIOME),
                                SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, NAMEK_GRASS_BLOCK)),
                        SurfaceRules.ifTrue(SurfaceRules.ON_CEILING, NAMEK_DIRT)),
