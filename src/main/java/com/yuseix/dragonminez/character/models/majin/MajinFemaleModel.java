package com.yuseix.dragonminez.character.models.majin;// Made with Blockbench 4.10.4
...
public class MajinFemaleModel<T extends LivingEntity> extends PlayerModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DragonMineZ.MOD_ID, "races"), "majin_female");
	...
	public MajinFemaleModel(ModelPart root) {
        super(root, false);
