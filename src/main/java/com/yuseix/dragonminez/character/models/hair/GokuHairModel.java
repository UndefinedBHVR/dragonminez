...
public class GokuHairModel extends HumanoidModel<AbstractClientPlayer> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = pelo1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 33).addBox(-1.05F, -3.0F, -1.25F, 1.75F, 2.0F, 2.25F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1356F, 3.7382F, 0.3061F, -0.0873F, 0.0F, -0.1309F));

		PartDefinition cube_r2 = pelo1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(-1, 33).addBox(-1.3F, -3.7F, -1.25F, 2.1F, 3.2F, 2.25F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.35F, 2.25F, -0.1F, -0.3491F, 0.0F, 0.3054F));

		PartDefinition pelo2 = gokucabello.addOrReplaceChild("pelo2", CubeListBuilder.create(), PartPose.offset(-4.2789F, -30.9079F, -3.5479F));

		PartDefinition cube_r3 = pelo2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 33).addBox(-1.1529F, -3.0994F, -0.5344F, 1.3F, 1.7F, 1.7F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2789F, 2.8579F, -1.0521F, -0.2618F, 0.0F, -0.0436F));

		PartDefinition cube_r4 = pelo2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 33).addBox(-0.778F, -3.5612F, -1.4672F, 1.8F, 3.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9711F, 1.1579F, -0.0521F, -0.1289F, 0.0227F, 0.5221F));

		PartDefinition pelo3 = gokucabello.addOrReplaceChild("pelo3", CubeListBuilder.create(), PartPose.offset(0.8609F, -33.5884F, -5.7549F));

		PartDefinition cube_r5 = pelo3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 33).addBox(-0.8F, -3.0F, -1.25F, 1.7F, 1.65F, 2.25F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.15F, 5.697F, 1.6596F, -0.0872F, 0.0038F, -0.0874F));

		PartDefinition cube_r6 = pelo3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 33).addBox(-2.1F, -3.0F, -1.25F, 3.4F, 2.5F, 2.25F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.05F, 3.603F, 1.8404F, 0.0F, 0.1745F, 0.829F));

		PartDefinition pelo4 = gokucabello.addOrReplaceChild("pelo4", CubeListBuilder.create(), PartPose.offset(7.815F, -33.4851F, -7.4328F));

		PartDefinition cube_r7 = pelo4.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 33).addBox(-0.87F, -2.8201F, -1.7156F, 1.65F, 1.85F, 2.25F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.515F, 5.2851F, 3.7328F, -0.2262F, -0.0032F, 0.1343F));

		PartDefinition cube_r8 = pelo4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 33).addBox(-1.0F, -3.75F, -1.5F, 2.3F, 3.25F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.515F, 3.3851F, 3.4328F, -0.2618F, 0.0F, -0.7418F));

		PartDefinition pelo5 = gokucabello.addOrReplaceChild("pelo5", CubeListBuilder.create(), PartPose.offset(4.0367F, -31.2182F, -3.1713F));

		PartDefinition cube_r9 = pelo5.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(1, 33).addBox(-0.4681F, -3.1953F, -1.9793F, 1.4F, 1.5F, 2.2F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3867F, 3.5682F, -0.0287F, -0.1298F, 0.017F, 0.1298F));

		PartDefinition cube_r10 = pelo5.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 33).addBox(-0.9943F, -3.7273F, -1.8862F, 2.05F, 2.4F, 2.7F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7443F, 2.0273F, -0.1138F, -0.1745F, 0.0F, -0.3491F));
		...
		PartDefinition pelo9 = gokucabello.addOrReplaceChild("pelo9", CubeListBuilder.create().texOffs(0, 33).addBox(-3.528F, -10.0612F, -4.4672F, 2.3F, 3.1F, 2.8F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7F, -19.9F, 6.4F, 0.0F, 0.0F, -0.5672F));
		...
		PartDefinition pelo11 = gokucabello.addOrReplaceChild("pelo11", CubeListBuilder.create().texOffs(0, 33).addBox(-2.728F, -9.7612F, -4.6672F, 3.1F, 2.2F, 3.6F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.3F, -25.2F, 5.7F, 0.0F, 0.0F, -1.1345F));
		...
		PartDefinition cube_r17 = pelo13.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(0, 33).addBox(-0.2631F, -1.4683F, 0.4328F, 2.0F, 2.1F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -7.0F, -3.6F, 0.0F, 0.0F, 0.2618F));
		...
		PartDefinition cube_r21 = pelo15.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(0, 33).addBox(-1.028F, -2.3612F, -1.0672F, 3.5F, 3.2F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.3351F, -7.2166F, -3.6F, 0.0F, 0.0F, -1.4399F));

		PartDefinition cube_r22 = pelo15.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(0, 33).addBox(-1.928F, -2.2612F, -1.3672F, 5.2F, 4.2F, 5.8F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.6599F, -6.2646F, -3.6F, 0.0F, 0.0F, -1.0036F));

		PartDefinition cube_r23 = pelo15.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(0, 33).addBox(-1.528F, -2.6612F, -1.8672F, 5.3F, 4.5F, 6.6F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, -4.45F, -3.6F, 0.0F, 0.0F, -0.7418F));
		...
		PartDefinition cube_r25 = pelo16.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(1, 33).addBox(0.122F, -0.4612F, -1.1672F, 2.25F, 3.05F, 4.8F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.8186F, -7.3924F, -3.6F, 0.0F, 0.0F, -0.1309F));

		PartDefinition cube_r26 = pelo16.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(0, 33).addBox(-1.628F, -2.6612F, -1.6672F, 4.1F, 4.5F, 5.8F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.75F, -5.0F, -3.6F, 0.0F, 0.0F, -0.2618F));
		...
		PartDefinition cube_r31 = pelo18.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(0, 33).addBox(-0.528F, -3.3612F, -1.2672F, 3.2F, 2.7F, 3.8F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -2.75F, -3.6F, 0.0F, 0.0F, -0.3491F));

		PartDefinition pelo19 = gokucabello.addOrReplaceChild("pelo19", CubeListBuilder.create().texOffs(0, 33).addBox(-3.328F, -10.0612F, -5.0672F, 2.0F, 2.5F, 2.2F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1108F, -18.3699F, 2.6F, 0.0F, 0.0F, 0.829F));

		PartDefinition pelo20 = gokucabello.addOrReplaceChild("pelo20", CubeListBuilder.create().texOffs(0, 33).addBox(-3.328F, -10.5612F, -4.9672F, 2.15F, 3.0F, 2.6F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0778F, -17.1692F, 4.5F, 0.0F, 0.0F, 0.6545F));

		PartDefinition pelo21 = gokucabello.addOrReplaceChild("pelo21", CubeListBuilder.create(), PartPose.offset(-3.0075F, -21.6339F, 5.1F));

		PartDefinition cube_r32 = pelo21.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(0, 33).addBox(0.972F, -3.0612F, -0.9672F, 2.2F, 2.75F, 3.2F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.9539F, -4.7318F, -3.6F, 0.0F, 0.0F, -0.3491F));
		...
		PartDefinition cube_r34 = pelo22.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(0, 33).addBox(-1.828F, -2.4612F, 0.7328F, 2.3F, 2.4F, 2.7F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2619F, 0.0058F, -1.7828F, 0.0F, 0.0F, 1.7017F));

		PartDefinition cube_r35 = pelo22.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(0, 33).addBox(-2.028F, -1.4612F, 0.6328F, 3.8F, 3.3F, 3.2F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7543F, -0.081F, -2.0328F, 0.0F, 0.0F, -0.2618F));
		...
		PartDefinition cube_r36 = pelo23.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(0, 33).addBox(-1.728F, 0.0388F, 0.9328F, 2.0F, 1.8F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4792F, -0.0382F, -1.8078F, 0.0F, 0.0F, 1.3963F));

		PartDefinition cube_r37 = pelo23.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(0, 33).addBox(-2.028F, -1.4612F, 0.4328F, 3.4F, 3.3F, 3.2F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6139F, 0.2313F, -1.8078F, 0.0F, 0.0F, -0.7418F));

		PartDefinition pelo24 = gokucabello.addOrReplaceChild("pelo24", CubeListBuilder.create().texOffs(0, 33).addBox(-3.328F, -10.0612F, -4.8672F, 2.25F, 2.5F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0809F, -17.291F, 6.5F, 0.0F, 0.0F, 0.6545F));

		PartDefinition pelo25 = gokucabello.addOrReplaceChild("pelo25", CubeListBuilder.create().texOffs(0, 33).addBox(-3.928F, -9.6612F, -4.6672F, 4.6F, 5.1F, 4.4F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, -30.8F, 4.8F, 0.0F, 0.0F, -1.309F));

		PartDefinition pelo26 = gokucabello.addOrReplaceChild("pelo26", CubeListBuilder.create().texOffs(0, 33).addBox(-3.528F, -8.0612F, -3.5672F, 2.6F, 2.2F, 2.9F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9936F, -32.4544F, 4.8F, 0.0F, 0.0F, -1.4399F));
		...
		PartDefinition cube_r38 = pelo27.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(0, 33).addBox(-0.828F, -3.2165F, -0.7877F, 1.8F, 2.5F, 2.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -7.0F, -3.6F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition cube_r39 = pelo28.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(0, 33).addBox(-0.828F, -3.2266F, -0.7905F, 2.0F, 2.5F, 2.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -7.0F, -3.6F, 0.0698F, 0.0F, 0.0F));
		...
		PartDefinition cube_r40 = pelo29.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(0, 33).addBox(-0.7649F, -3.8083F, -0.789F, 2.5F, 3.1F, 2.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.3F, -7.0F, -3.6F, 0.0896F, -0.0181F, -0.2612F));
		...
		PartDefinition cube_r42 = pelo31.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(0, 33).addBox(-0.8111F, -4.4377F, -0.7724F, 2.8F, 3.8F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7F, -7.1F, -3.6F, 0.0F, 0.0F, -0.2182F));
		...
		PartDefinition cube_r43 = pelo32.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(0, 33).addBox(-2.1416F, -4.5383F, -0.7724F, 3.1F, 3.9F, 2.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9F, -7.0F, -3.6F, 0.0F, 0.0F, 0.1745F));

		PartDefinition pelo33 = gokucabello.addOrReplaceChild("pelo33", CubeListBuilder.create().texOffs(0, 33).addBox(-4.328F, -11.6499F, -4.5738F, 2.5F, 4.0F, 2.95F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7191F, -18.3358F, 5.5859F, -0.1484F, 0.0F, 0.0F));
		...
		PartDefinition cube_r44 = pelo34.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(0, 33).addBox(-4.928F, -5.1439F, -1.0789F, 6.5F, 4.5F, 2.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1F, -6.8F, -3.4F, -0.0436F, 0.0F, 0.0F));
