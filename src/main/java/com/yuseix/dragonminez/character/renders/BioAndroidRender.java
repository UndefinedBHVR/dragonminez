...
public class BioAndroidRender extends LivingEntityRenderer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
                ...
                switch (transformacion){
                    case 0:
                        ...
                        if(isAuraOn){ //Si el jugador esta activando el Aura
                            renderAuraBase2(pEntity, pPoseStack, pBuffer, pPackedLight, pPartialTicks, 0.15F, colorAura);
                        }
                        break;
                }
    ...
    private void renderAuraBase2(AbstractClientPlayer pEntity, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, float pPartialTicks, float transparencia, int colorAura){
        ...
        VertexConsumer vertexConsumer = pBuffer.getBuffer(CustomRenderTypes.energy2(TextureManager.AURA_BASE));
