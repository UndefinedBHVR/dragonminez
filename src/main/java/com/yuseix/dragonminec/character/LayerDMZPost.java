...
public class LayerDMZPost extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    private static final ResourceLocation OJOS = new ResourceLocation(DragonMineC.MODID, "textures/races/ojosblancos.png");

    private final FaceModel model;

    private static final ResourceLocation OJO1 = new ResourceLocation(DragonMineC.MODID, "textures/races/ojo1.png");
    private static final ResourceLocation OJO2 = new ResourceLocation(DragonMineC.MODID, "textures/races/ojo2.png");
